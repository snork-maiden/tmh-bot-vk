...
`,
  ...
  connectAdmin: `Отправьте свой вопрос и ожидайте ответа. Если вы нажмете кнопку "Главное меню", чат с админками сбросится`,
  createPost: {
  ...
  rejectPost: {
    ...
    timer:'Ваш пост стоит на таймере! Это значит, что он будет опубликован через несколько часов.',
    rejected:'Ваш пост отклонен. Нажмите «Далее», чтобы узнать возможные причины.',
